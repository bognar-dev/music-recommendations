...
import { stepFourSchema} from '@/lib/survey-schema';
...
export const stepFourFormAction = async (
    ...
    console.log("surveyDataObj", surveyDataObj.stepFour);    
    const validated = stepFourSchema.safeParse(surveyDataObj.stepFour);
    ...
    postHogServer.capture({
        distinctId: "server",
        event: "stepFourFormSubmit",
        properties: { modelRating, songRatings }
    });
    

    redirect(AddDealRoutes.M_2_P2);
};