...
import { stepFiveSchema} from '@/lib/survey-schema';
...
export const stepFiveFormAction = async (
    ...
    console.log("surveyDataObj", surveyDataObj.stepFive);    
    const validated = stepFiveSchema.safeParse(surveyDataObj.stepFive);
    ...
    postHogServer.capture({
        distinctId: "server",
        event: "stepFiveFormSubmit",
        properties: { modelRating, songRatings }
    });
    

    redirect(AddDealRoutes.M_2_P3);
};