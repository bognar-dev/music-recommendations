...
import { stepSixSchema} from '@/lib/survey-schema';
...
export const stepSixFormAction = async (
    ...
    console.log("surveyDataObj", surveyDataObj.stepSix);    
    const validated = stepSixSchema.safeParse(surveyDataObj.stepSix);
    ...
    postHogServer.capture({
        distinctId: "server",
        event: "stepSixFormSubmit",
        properties: { modelRating, songRatings }
    });
    

    redirect(AddDealRoutes.M_3_P1);
};